<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm2.aspx.cs" Inherits="WebApplication_Creater_Bhuvana.WebForm2" %>
          ...
          <li class="menu-has-children"><a href="">Drop Down</a>
            <ul>
              ...
              <li><a href="#">Drop Down 5</a></li>
                        ...
                        <li><a href="WebForm3.aspx">Logout</a></li>
                    </ul>
                </nav>
                <!-- #nav-menu-container -->
            </div>
            ...
            <div class="intro-content">
                ...
                <div>
                    ...
                    <div runat="server" id="DivSignup" style="display: block">
                        <button type="button" class="btn-get-started" data-toggle="modal" data-target="#myModal">Book Events</button>
                    </div>


                </div>
                    <div>
                        <asp:GridView  runat="server" id="gridView" CssClass="table table-hover table-striped" GridLines="None" >
                ...
                <div runat="server" id="Divsuc" style="display: block">
                    <h5>Hi You have successfully Booked!!!</h5>
                </div>
                <div runat="server" id="Divfil" style="display: block">
                    <h5>Hi Event Slot Time is already booked try some other slot!!!</h5>
                </div>
            ...
            <div class="text-center" ><button type="button" id="Submit" class="btn btn-default"  onclick="return SubmitCustomer();">Submit</button></div>--%>
                        ...
                        <div class="card">
                            <div class="card-header bg-primary text-white">
                                <h4 class="card-title text-uppercase">Book Event</h4>
                            </div>
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="col-xl-4">
                                        <h6>Login User:<asp:Label runat="server" ID="lblUser"></asp:Label></h6>
                                    </div>
                                    <div class="col-xl-4">
                                        <h6>Mobile:<asp:Label runat="server" ID="lblMobile"></asp:Label></h6>
                                    </div>
                                    <div class="col-xl-4">
                                        <h6>Email:<asp:Label runat="server" ID="lblemail"></asp:Label></h6>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-xl-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="eventname" placeholder="Event Name" maxlength="50" class="form-control" runat="server" aria-describedby="inputGroupPrepend" required="required" />
                                            <div class="invalid-feedback">
                                ...
                                <div class="form-row">
                                    <div class="col-xl-12">
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="eventdate" placeholder="Enter Date" class="form-control" runat="server" aria-describedby="inputGroupPrepend" required="required" />
                                            <div class="invalid-feedback">
                                ...
                                <div class="form-row">
                                    <div class="col-xl-12">
                                        <div class="form-group">
                                            <label for="feventtime">Event Time</label>
                                            <input type="time" id="feventtime" placeholder="Enter Time" class="form-control" runat="server" aria-describedby="inputGroupPrepend" required="required" />
                                            <div class="invalid-feedback">
                                ...
                                <div class="form-row">
                                    <div class="col-xl-12">
                                        <div class="form-group">
                                            <label for="teventtime">Event Time</label>
                                            <input type="time" id="teventtime" placeholder="Enter Time" class="form-control" runat="server" aria-describedby="inputGroupPrepend" required="required" />
                                            <div class="invalid-feedback">
                                 ...
                                 <div class="form-row">
                                    <div class="col-xl-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="remarks" placeholder="Remarks"  maxlength="50"     class="form-control" runat="server" aria-describedby="inputGroupPrepend" required="required" />
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12 col-xs-12">
                                            <div class="float-right">
                                                ...
                                                <asp:Button ID="submit" runat="server" class="btn btn-primary rounded-0" OnClick="submit_Click" Text="Submit" />
