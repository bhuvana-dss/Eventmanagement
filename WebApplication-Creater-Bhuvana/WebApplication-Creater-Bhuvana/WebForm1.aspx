<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="WebApplication_Creater_Bhuvana.WebForm1" %>
          ...
          <li class="menu-has-children"><a href="">Drop Down</a>
            <ul>
              ...
              <li><a href="#">Drop Down 5</a></li>
                        ...
                        <li><a href="WebForm3.aspx">Login</a></li>
                    </ul>
                </nav>
                <!-- #nav-menu-container -->
            </div>
        ...
        <section id="intro">
            ...
            <div class="intro-content">
                ...
                <div>
                    ...
                    <div runat="server" id="DivSignup" style="display: block">
                     ...
                     <div runat="server" id="DivLogin" style="display: block">
                        <button type="button" class="btn-get-started" data-toggle="modal" data-target="#myModal1">Book Events</button>
                    </div>
                ...
                <div runat="server" id="Divfil" style="display: block">
                    <h5>Hi You have already registered!!! Please proceed with Login !!!</h5>
                </div>
                        ...
                        <div class="form-row">
                            <div class="col-xl-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="firstname" placeholder="First Name" class="form-control" runat="server" aria-describedby="inputGroupPrepend" required="required" />
                                    <div class="invalid-feedback">
                        ...
                        <div class="form-row">
                            <div class="col-xl-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="lastname" placeholder="Last Name" class="form-control" runat="server" aria-describedby="inputGroupPrepend" required="required" />
                                    <div class="invalid-feedback">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-xl-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" runat="server" class="form-control" id="email" placeholder="email address" aria-describedby="inputGroupPrepend" required="required" />
                                    <div class="invalid-feedback">
                                        Please provide a valid email.  
                                    </div>
                                </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-xl-12">
                                <div class="form-group">
                                    ...
                                    <input type="password" maxlength="10" class="form-control" id="paswd" runat="server" placeholder="Password" aria-describedby="inputGroupPrepend" required="required" />
                                    <div class="invalid-feedback">
                                        Please enter complex password.  
                                    </div>
                                </div>
                        ...
                        <div class="form-row">
                            <div class="col-xl-12">
                                <div class="form-group">
                                    ...
                                    <input type="tel" maxlength="15" class="form-control" id="phonenumber" runat="server" placeholder="Mobile Number" aria-describedby="inputGroupPrepend" required="required" />
                                    <div class="invalid-feedback">
                        ...
                        <div class="form-row">
                            <div class="col-xl-12">
                                <div class="form-group">
                                    ...
                                    <input type="tel" maxlength="15" class="form-control" id="telephone" runat="server" placeholder="Telephone Number" aria-describedby="inputGroupPrepend" />
                                    <div class="invalid-feedback">
                        ...
                        <div class="form-row">
                            <div class="col-xl-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" maxlength="50" class="form-control" id="compname" runat="server" placeholder="Company Name" aria-describedby="inputGroupPrepend" />
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-sm-12 col-md-12 col-xs-12">  
                                    ...
                                    <div class="form-check-inline">  
                                        <div class="custom-control custom-radio ">  
                                            <input type="radio" class="custom-control-input" id="html" aria-describedby="inputGroupPrepend" name="radio-html" required="required"/>  
                                    ...
                                    <div class="form-check-inline">  
                                        <div class="custom-control custom-radio ">  
                                            <input type="radio" class="custom-control-input" id="javascript" aria-describedby="inputGroupPrepend" name="radio-javascript" required="required"/>  
                                    ...
                                    <div class="form-check-inline">  
                                        <div class="custom-control custom-radio ">  
                                            <input type="radio" class="custom-control-input" id="csharp" aria-describedby="inputGroupPrepend" name="radio-csharp" required="required"/>  
                                    ...
                                    <div class="form-check-inline">  
                                        <div class="custom-control custom-radio">  
                                            <input type="radio" class="custom-control-input" id="aspdotnet" aria-describedby="inputGroupPrepend" name="radio-aspdotnet" required="required"/>    
                                    ...
                                    <div class="form-check-inline">  
                                        <div class="custom-control custom-radio">  
                                            <input type="radio" class="custom-control-input" id="MVC" name="radio-MVC" required="required"/>  
                                ...
                                <div class="col-sm-12 col-md-12 col-xs-12">  
                                    <div class="form-group">  
                                        ...
                                        <div class="custom-file">  
                                            <input type="file" class="custom-file-input" id="validatedCustomFile" required="required"/>   
                            ...
                            <div class="row">  
                                <div class="col-sm-12 col-md-12 col-xs-12">  
                                    <div class="form-group">  
                                        ...
                                        <textarea class="form-control" rows="3" id="address" aria-describedby="inputGroupPrepend" required="required"></textarea>  
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12 col-xs-12">
                                <div class="float-right">
                                   ...
                                   <%--  <button type="button"  class="btn btn-primary rounded-0" data-dismiss="modal" data-toggle="modal" data-target="#myModal1">Register</button>
                                 <asp:Button ID="Button1" runat="server" class="btn btn-primary rounded-0" OnClick="submit_Click" Text="Register" />--%>

                                    <asp:Button ID="submit" runat="server" class="btn btn-primary rounded-0" OnClick="submit_Click" Text="Register" />
                                </div>
                            </div>
                        </div>
